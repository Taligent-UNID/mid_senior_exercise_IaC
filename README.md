...
- Se disponibilizo un set de datos no catalogados en esta carpeta de S3: s3://challenge-aws-iac/
- Dichos datos deben ser migrados en la siguiente carpeta de S3: s3://challenge-aws-iac/processed/
